...
const world_bounds_y = -1100;
const world_bounds_width = 640;
const world_bounds_height = 1200;

// Camera data
const camera_bounds_x = 0;
const camera_bounds_y = -1100;
const camera_bounds_width = 640;
const camera_bounds_height = 1200;

// Player data
const player_start_x = 320;
const player_start_y = -100;
const player_jump_velocity = -340;
