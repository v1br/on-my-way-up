Main = {
	...
	create() {
		...
		// Player
		player = this.physics.add.sprite(player_start_x, player_start_y, 'frog_idle');
		...
		camera.setBounds(world_bounds_x, world_bounds_y, world_bounds_width, world_bounds_height);
